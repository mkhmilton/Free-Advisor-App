...
import ChildClasses.Businessman;
import java.awt.Toolkit;
import java.awt.event.WindowEvent;
import javax.swing.JOptionPane;


public class BusinessmanGUI extends javax.swing.JFrame {

    public BusinessmanGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("2. Average Business Meeting Time");
        ...
        jLabel13.setText("For Businessman");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jButtonOk, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOkActionPerformed
        ...
        try {
            ...
            Businessman houseWife = new Businessman(age, workingTime, sleepingTime, internetBrowsingTime, mobillephoneUsingTime, "Businessman");

            String advice = "Your profession is: " + houseWife.getProfession() + "\n\n1. " + houseWife.getWorkingMessage() + "\n2. " + houseWife.getSleepingMessage() +
            "\n3. " + houseWife.getInternetBrowsingMessage() + "\n4. " + houseWife.getMobilephoneMessage();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusinessmanGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new BusinessmanGUI().setVisible(true);
            }
        });
    }
