...
public class ServiceHolder extends Person {
    Profession profession = new Profession();
    
    private double avgWorkingTime;
    private String workingTimeresult;

    public ServiceHolder(double a, double workingTime,  double sleepingTime, double internetBrowsingTime, double mobilephoneusingTime, String p) {
        age = a;   
    ...
    public String getWorkingMessage() {
        if (avgWorkingTime == 8) {
            workingTimeresult = "Your working time is average and that's good for your health.";
        } else if (avgWorkingTime > 8) {
            workingTimeresult = "You are working more than the average time. It would be better\nif you don't work more than 8 hours. ";
        } else if (avgWorkingTime < 8) {
            workingTimeresult = "You are working less than the average time. It would be better \nif you work at least for 8 hours.";
        }
